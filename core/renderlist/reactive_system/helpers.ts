...
} from "renderlist/errors";
import {
  indexObjType,
  iterableEachTypes,
  renderingSystemType,
  reservedPropsSettingInterface,
} from "renderlist/interfaces";
...
export function defineReservedProps(
  props: reservedPropsSettingInterface[],
  targetObj: Object
): void {
...
export function defineReactiveProp(
  ...
  Object.defineProperty(targetObj, prop, {
    set(newValue) {
      ...
      checkType(newValue, renderingSystem, null, hasIndexObj ? indexObj : null);
    },
...
export function runObserveCallBack(
  each: iterableEachTypes,
  proxy: iterableEachTypes
) {
