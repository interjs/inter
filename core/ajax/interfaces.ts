...
type okayOrErrorHandlerType = (response: BackendRequestResponseInterface) => void;
export interface BackendRequesHandlersInterface {
    ...
    response(okayhandler: okayOrErrorHandlerType, errorHandler: okayOrErrorHandlerType): void,
}
